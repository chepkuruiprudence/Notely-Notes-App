...
const Notes = () => {
  ...
  if (isError) {
    return (0, jsx_runtime_1.jsx)(material_1.Stack, {
      sx: { p: 5 },
      alignItems: "center",
      children: (0, jsx_runtime_1.jsxs)(material_1.Alert, {
        severity: "error",
        children: ["Failed to load Notes: ", error.message],
      }),
    });
  }
  if (isLoading) {
          ...
          children: (0, jsx_runtime_1.jsxs)(material_1.CardContent, {
            children: [
              (0, jsx_runtime_1.jsx)(material_1.Typography, {
                variant: "h6",
                gutterBottom: true,
                children: "Normalize creating notes.",
              }),
