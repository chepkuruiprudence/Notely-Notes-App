    ...
    children: (0, jsx_runtime_1.jsxs)(react_router_dom_1.BrowserRouter, {
      children: [
        ...
        (0, jsx_runtime_1.jsxs)(react_router_dom_1.Routes, {
          children: [
            (0, jsx_runtime_1.jsxs)(react_router_dom_1.Route, {
              element: (0, jsx_runtime_1.jsx)(Protectedroutes_1.default, {}),
              children: [
                (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
                  path: "/Createnote",
                  element: (0, jsx_runtime_1.jsx)(CreateNote_1.default, {}),
                }),
                (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
                  path: "/Mynotes",
                  element: (0, jsx_runtime_1.jsx)(MyNotes_1.default, {}),
                }),
                (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
                  path: "/profile",
                  element: (0, jsx_runtime_1.jsx)(Profile_1.default, {}),
                }),
                (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
                  path: "/dashboard",
            ...
            (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
              path: "/Notes",
              element: (0, jsx_runtime_1.jsx)(Notes_1.default, {}),
            }),
            (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
              path: "/Login",
            ...
            (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
              path: "/register",
              element: (0, jsx_runtime_1.jsx)(Register_1.default, {}),
            }),
            (0, jsx_runtime_1.jsx)(react_router_dom_1.Route, {
              path: "/notes/:noteId",
              element: (0, jsx_runtime_1.jsx)(Fullnote_1.default, {}),
            }),
          ],
        }),
