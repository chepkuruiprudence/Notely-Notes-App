...
router.patch("/upload-profile-image", auth_middleware_1.default, upload_1.default.single("profileImage"), user_controller_1.updateProfile);
router.patch("/user", auth_middleware_1.default, user_controller_1.updateUserProfile);
