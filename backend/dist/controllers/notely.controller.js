...
exports.toggleNotePin =
  exports.restoreDeletedNote =
  exports.deleteNote =
  exports.updateNote =
  exports.getSpecificNote =
  exports.createNote =
  exports.getAllNotes =
    void 0;
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!title || !synopsis || !content || typeof isPublic !== "boolean") {
        return res
          .status(400)
          .json({ message: "Missing required body field." });
      }
...
const restoreDeletedNote = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const userId = req.user.id;
      const noteId = req.params.id;
